...
class Power_system_2:
    ...
    def __init__(self):
        ...
        self.Y,self.V,self.Fx,self.gx,self.Fi,self.gi = vertices(self.A,self.B,self.E,self.X,self.U,self.D,self.dt,self.env_name)
    ...
    def reset(self):
        ...
        th = np.random.uniform(low = -frac_th*self.safe_th,high=frac_th*self.safe_th)
        ...
        thdot=np.random.uniform(low=frac_thdot*thdot_min,high=frac_thdot*thdot_max)
